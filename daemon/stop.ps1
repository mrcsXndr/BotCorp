...
# it), the guarded tree-kill on the recorded claude pid, and the pty-host if
# one is attached. Every kill goes through Get-ProcessOwnerRecord: nothing that
